...
class UsuarioController
{
    ...
    {
        $respuesta = "";
        $respuesta = Usuario::find($_POST['id']);
    ...
    {
        $respuesta = "";
        $usuario = Usuario::find($_POST['id']); //trae el objeto
        $usuario->apellido = $_POST['apellido'];
        $usuario->nombre = $_POST['nombre'];
        $usuario->id_localidad = $_POST['id_localidad'];
    ...
    {
        $respuesta = "";
        $usuario = Usuario::find($args['id']); //trae el objeto
    ...
    public function validarTipo($tipo)
    {
        if ($tipo != "alumno" && $tipo != "profesor" && $tipo != "admin") {
            throw new Exception("El tipo puede ser alumno, profesor o admin");
        }
        return true;
    }
